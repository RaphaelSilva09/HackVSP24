...
const debugRouteLinkMap = {
  ...
  '/loginPage':
      'https://app.flutterflow.io/project/verdadeira-s-p2-yfetd7?tab=uiBuilder&page=LoginPage',
  '/profilePage':
      'https://app.flutterflow.io/project/verdadeira-s-p2-yfetd7?tab=uiBuilder&page=profilePage',
  '/mapPage':
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? MapPageWidget() : LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => MapPageWidget(
            localizacaoID: params.getParam(
              'localizacaoID',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['marker'],
            ),
            id: params.getParam<LatLng>(
              'id',
              ParamType.LatLng,
              isList: true,
            ),
        ...
        FFRoute(
          name: 'TouristicPointPage',
          path: '/touristicPointPage',
          builder: (context, params) => TouristicPointPageWidget(),
        ),
        FFRoute(
          name: 'rankingPage',
          path: '/rankingPage',
